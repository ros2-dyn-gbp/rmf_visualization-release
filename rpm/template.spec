...
%global pkg_name rmf_visualization_building_systems
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-rmf-visualization-building-systems
Version:        2.2.1
Release:        2%{?dist}
...
%changelog
* Fri Mar 22 2024 Yadunund <yadunund@openrobotics.org> - 2.2.1-2
